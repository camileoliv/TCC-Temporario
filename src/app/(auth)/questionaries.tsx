...
export default function Questions() {
  ...
  const handleAnswer = ( question: 'memoria' | 'rotina' | 'associacao',
    ...
    style={{backgroundColor: "#FCFCFE"}}>
      ...
      <View className='flex flex-col justify-center items-center px-6'>
        ...
        <View className='flex flex-row gap-10'>
          <CustomButton value='nao' onPress={() => handleAnswer('memoria', 'nao')} title='Não' shouldChangeColor={true} activeBgColor='bg-[#F3D175]' />
          <CustomButton value='nao sei' onPress={() => handleAnswer('memoria', 'nao sei')} title='Não sei' shouldChangeColor={true} activeBgColor='bg-[#F3D175]' />
          <CustomButton value='sim' onPress={() => handleAnswer('memoria', 'sim')} title='Sim' shouldChangeColor={true} activeBgColor='bg-[#F3D175]' />
        </View>
      </View>
      ...
      <View className='flex flex-col justify-center items-center px-6'>
          ...
          <View className='flex flex-row gap-10'>
            <CustomButton value='nao' onPress={() => handleAnswer('rotina', 'nao')} title='Não' shouldChangeColor={true} activeBgColor='bg-[#F3D175]' />
            <CustomButton value='nao sei' onPress={() => handleAnswer('rotina', 'nao sei')} title='Não sei' shouldChangeColor={true} activeBgColor='bg-[#F3D175]' />
            <CustomButton value='sim' onPress={() => handleAnswer('rotina', 'sim')} title='Sim' shouldChangeColor={true} activeBgColor='bg-[#F3D175]' />
          </View>
      </View>
      ...
      <View className='flex flex-col justify-center items-center px-6'>
        ...
        <View className='flex flex-row gap-10'>
          <CustomButton value='nao' onPress={() => handleAnswer('associacao', 'nao')} title='Não' shouldChangeColor={true} activeBgColor='bg-[#F3D175]' />
          <CustomButton value='nao sei' onPress={() => handleAnswer('associacao', 'nao sei')} title='Não sei' shouldChangeColor={true} activeBgColor='bg-[#F3D175]' />
          <CustomButton value='sim' onPress={() => handleAnswer('associacao', 'sim')} title='Sim' shouldChangeColor={true} activeBgColor='bg-[#F3D175]' />
        </View>
      </View>
        ...
        <TouchableOpacity
          ...
          <View className='flex flex-row h-16 w-44 justify-center items-center  border-[2.9px] rounded-3xl gap-2'
